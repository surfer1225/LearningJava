...
/*
Problem
Anna has a row of N blocks, each with exactly one letter from A to Z written on it.
...
The i-th question is: can Anna use all of the blocks numbered from Li to Ri,
...
Then, Q lines follow. The i-th line contains the two integers Li to Ri, describing the i-th question.
